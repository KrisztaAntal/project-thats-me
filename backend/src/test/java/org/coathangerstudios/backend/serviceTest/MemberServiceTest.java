...
public class MemberServiceTest {
    ...
    public void testSignUp_MemberWithUsernameOrEmailAlreadyExists() {
        MemberService memberService = new MemberService(authenticationManagerMock, memberRepositoryMock, passwordEncoderMock, jwtUtilsMock, memberRoleServiceMock, defaultAvatarServiceMock, dtoMapperServiceMock, imageServiceMock);
